...
class CustomWatchface : BaseWatchFace() {
    ...
    override fun setColorDark() {
        ...
        //******************************
        // Absolute final BG color enforcement before chart setup
        binding.sgv.setTextColor(bgColor(0))
        binding.sgvExt1.setTextColor(bgColor(1))
        binding.sgvExt2.setTextColor(bgColor(2))
        setupCharts()
    ...
    private fun setWatchfaceStyle() {
        ...
        customWatchfaceData?.let {
            ...
            try {
                ...
                // Always enforce correct BG colors regardless of watchface JSON or dynPref
                highColor = 0xFFFFFF00.toInt()   // Yellow  - high BG
                midColor  = 0xFF00FF00.toInt()   // Green   - in range BG
                lowColor  = 0xFFFF0000.toInt()   // Red     - low BG
