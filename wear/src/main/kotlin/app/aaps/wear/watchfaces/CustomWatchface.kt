    ...
    private enum class ViewMap(
        ...
        fun customizeTextView(view: TextView, cwf: CustomWatchface) {
            ...
            viewJson?.let { viewJson ->
                ...
                val sgvInRangeColor = when (this) {
                    ViewMap.SGV      -> if (cwf.singleBg[0].sgvLevel == 0L) cwf.midColor else null
                    ViewMap.SGV_EXT1 -> if (cwf.singleBg[1].sgvLevel == 0L) cwf.midColor else null
                    ViewMap.SGV_EXT2 -> if (cwf.singleBg[2].sgvLevel == 0L) cwf.midColor else null
                    else             -> null
                }
                view.setTextColor(
                    sgvInRangeColor
