                    ...
                    if (view is TextView) {
                        json.put(
                            ...
                            JSONObject()
                                ...
                                .put(JsonKeys.FONTCOLOR.key, if (it == ViewMap.SGV || it == ViewMap.SGV_EXT1 || it == ViewMap.SGV_EXT2) JsonKeyValues.BGCOLOR.key else String.format("#%06X", 0xFFFFFF and view.currentTextColor))
                        )
                    }
